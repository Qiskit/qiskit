...
1. Make sure you have pushed your branch with the latest changes.
2. Go to link: `https://mybinder.org/v2/gh/<github_user>/qiskit-terra/<branch>?urlpath=apps/test/ipynb/mpl_tester.ipynb`. 
This opens a jupyter application running in the cloud that automatically runs 
...
you just need to update the reference images as follows:
  ...
  replacing the existing reference images
    - commit and push your changes, restart the jupyter app in your browser. The 
  tests should now pass.
5. Add new snapshot tests covering your new contributions.
    ...
    - commit and push your changes, restart the jupyter app in your browser. 

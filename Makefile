...
doc:
	...
	for LANGUAGE in "." "de" "ja"; do \
		better-apidoc -f -o doc/$$LANGUAGE/_autodoc --no-toc --private --maxdepth=5 --separate --templates=doc/_templates/better-apidoc qiskit qiskit/terra/tools qiskit/terra/wrapper/jupyter "qiskit/terra/extensions/standard/[a-z]*"; \

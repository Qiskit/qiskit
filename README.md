...
2. Get an API token from the IBM Q website under _My Account > API Token_ for the account.

3. Take your token and url from step 2, here called `MY_API_TOKEN`, and run:

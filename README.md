...
At least [Python 3.5 or later](https://www.python.org/downloads/) is needed for using QISKit. In addition, [Jupyter notebooks](https://jupyter.readthedocs.io/en/latest/install.html) are recommended for interacting with the tutorials.

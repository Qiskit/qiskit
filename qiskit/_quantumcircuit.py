...
class QuantumCircuit(object):
    ...
    @staticmethod
    def from_qasm_string(qasm_string, name=None,
    ...
    @staticmethod
    def from_qasm_file(qasm_file, name=None,
                       basis_gates="id,u0,u1,u2,u3,x,y,z,h,s,sdg,t,tdg,rx,"
                                   "ry,rz,cx,cy,cz,ch,crz,cu1,cu3,swap,ccx,"
                                   "cswap"):
        ...
        from_qasm_string = QuantumCircuit.from_qasm_string
        return from_qasm_string(qasm_data, name=name, basis_gates=basis_gates)

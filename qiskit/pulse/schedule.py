...
class Schedule:
    ...
    def __init__(self,
        ...
        self._name = name
        self._parameter_table = ParameterManager()
    ...
    def parameters(self) -> Set:
        ...
        return self._parameter_table.parameters
    ...
    def _mutable_insert(self,
        ...
        self._parameter_table.update_parameter_table(schedule)
        return self
    ...
    def replace(self,
        ...
        if inplace:
            ...
            self._parameter_table._parameters = new_parameters
            return self
        else:
            try:
    ...
    def is_parameterized(self) -> bool:
        ...
        return self._parameter_table.is_parameterized()
    ...
    def assign_parameters(self,
        ...
        """
        return self._parameter_table.assign_parameters(
            pulse_program=self,
    ...
    def get_parameters(self,
        ...
        """
        return self._parameter_table.get_parameters(parameter_name)
...
class ScheduleBlock:
    ...
    def __init__(self,
        ...
        self._parameter_table.update_parameter_table(self._alignment_context)
    ...
    def is_schedulable(self) -> bool:
        ...
        return all(block.is_schedulable() if isinstance(block, ScheduleBlock) else
    ...
    def append(self, schedule: BlockComponent,
        ...
        if not isinstance(schedule, (ScheduleBlock, Instruction)):
            raise PulseError(f'Appended `schedule` {schedule.__class__.__name__} is invalid type. '

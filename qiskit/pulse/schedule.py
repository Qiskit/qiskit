...
class PulseProgram(abc.ABC):
    ...
    def __init__(self,
        ...
        """Create data container for pulse instructions.
    ...
    def insert(self,
               start_time: int,
               schedule: Union['PulseProgram', Instruction],
               name: Optional[str] = None,
               inplace: bool = False
               ) -> 'PulseProgram':
    ...
    def filter(self, *filter_funcs: List[Callable],
               ...
               check_subroutine: bool = True) -> 'PulseProgram':
    ...
    def replace(self,
                old: Union['PulseProgram', Instruction],
                new: Union['PulseProgram', Instruction],
                inplace: bool = False,
                ) -> 'Schedule':
    ...
    def _update_parameter_table(self, schedule: 'PulseProgram'):

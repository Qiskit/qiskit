...
def push_append(
    this: List[pulse.ScheduleComponent],
...
def left_align(
    *instructions: List[Union[pulse.Instruction, pulse.Schedule]]
) -> pulse.Schedule:
...
def right_align(
    *instructions: List[pulse.ScheduleComponent]
) -> pulse.Schedule:
...
def left_barrier(
    *instructions: List[pulse.ScheduleComponent], channels=None
) -> pulse.Schedule:

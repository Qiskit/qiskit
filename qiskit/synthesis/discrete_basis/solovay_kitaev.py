...
class SolovayKitaevDecomposition:
    ...
    This is a legacy implementation which will be deprecated in the future. It is suggested
    to use :class:`SolovayKitaevCompiler` instead, which is more accurate and faster.
    """

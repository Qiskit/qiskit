...
from qiskit._accelerate.permutation import permutation_utils as permutation_utils_rs
...
def _get_ordered_swap(permutation_in):
    ...
    """
    return permutation_utils_rs._get_ordered_swap(permutation_in)


def _inverse_pattern(pattern):
    """Finds inverse of a permutation pattern."""
    return permutation_utils_rs._inverse_pattern(pattern)

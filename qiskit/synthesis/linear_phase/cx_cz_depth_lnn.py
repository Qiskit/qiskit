...
def synth_cx_cz_line_my(Mx, Mz):
    ...
    Args:
        Mz: a boolean symetric matrix representing a CZ circuit.
            Mz[i][j]=1 represents a CZ(i,j) gate

        Mx: a boolean invertible matrix representing a CX circuit.
    ...
    # First, find circuits implementing Mx by Proposition 7.3 and Proposition 7.4 of [1]

...
class PassManager():
    ...
    def _join_options(self, passset_options):
        ...
        passset options (set via ``PassManager.add()``) override
    ...
    def add(self, passes, ignore_requires=None, ignore_preserves=None, max_iteration=None,

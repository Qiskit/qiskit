...
def generate_translation_passmanager(
    ...
    if method == "translator":
        ...
        unroll = [
            # Decompose DCX and other gates with definitions before translation.
            # This is necessary for gates inside control flow blocks which are not
            # decomposed by HighLevelSynthesis (issue #15734).
            Decompose(["dcx"]),

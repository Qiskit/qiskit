    ...
    **References:**
    ...
    def run(self, dag):
        ...
        for i in range(self.max_iterations):
            ...
            # Diagnostics
            logger.info("After round %d, num_swaps: %d", i + 1, new_circ.count_ops().get("swap", 0))
    ...
    def _compose_layouts(self, initial_layout, pass_final_layout, qregs):
        ...
        pass_final_layout = Layout(
            {trivial_layout[v.index]: p for v, p in pass_final_layout.get_virtual_bits().items()}
        )

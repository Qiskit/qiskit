...
try:
    ...
    HAS_Z3 = False
from qiskit.circuit.standard_gates import IGate, XGate, YGate, ZGate
from qiskit.circuit.standard_gates import CXGate, CCXGate, CYGate, CZGate
from qiskit.circuit.standard_gates import TGate, TdgGate, SGate, SdgGate, RZGate, U1Gate
from qiskit.circuit.standard_gates import SwapGate, CSwapGate, CRZGate, CU1Gate

...
The decomposition is base on https://arxiv.org/pdf/quant-ph/0406176.pdf by Shende et al.
    ...
    Args:
        ...
        q_controls (QautnumRegister|list[(QuantumRegister,int)]): list of k control qubits
            ...
            (with q = QuantumRegister(2)), the rotation Ry(a_0)is performed if q[1] and q[2] are in
            the state zero, the rotation  Ry(a_1) is performed if q[1] is in the state one and q[2]

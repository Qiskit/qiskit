        ...
        **matplotlib**: images with color rendered purely in Python.
        ...
        Args:
            ...
            style (dict or str): dictionary of style or file name of style
                ...
                str ispassed in that is the path to a json file which contains
            ...
            interactive (bool): when set true show the circuit in a new window
                ...
                silently ignored.
            line_length (int): Deprecated, see `fold` which superseceds this
            ...
            fold (int): Sets pagination. It can be disabled using -1.
                ...
                amount of operations before folding. Default is 25.
        Returns:
        ...
        Raises:
            ...
            ImportError: when the output methods requieres non-installed
                libraries.
        """

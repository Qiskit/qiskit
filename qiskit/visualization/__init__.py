...
obtained from a :class:`~qiskit.QuantumCircuit`.
...
The figures created by counts and state visualizations functions are mostly generated by
`Matplotlib <https://matplotlib.org/>`_. As a result there are keyargs inherited from
`Matplotlib` that are common to most functions, including:

...
class LinCombQFI(LinCombQGT):
    ...
    **Reference:**
    ...
    def __init__(
        ...
        self._derivative_type = DerivativeType.REAL
        self._qgt = LinCombQGT(estimator, phase_fix, DerivativeType.REAL, options=options)
    ...
    def _run(
        ...
        **options,
        ...
        result = self._qgt._run(circuits, parameter_values, parameter_sets, **options)
        return QGTResult(

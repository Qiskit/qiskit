...
class FakeJohannesburgECR(FakeBackend):
    """A fake Johannesburg backend with ECR native gate."""
    ...
    def properties(self):
        ...
        dirname = os.path.dirname(__file__)
        filename = "props_johannesburg_ecr.json"
    ...
    def defaults(self):
        ...
        if not self._defaults:
            dirname = os.path.dirname(__file__)
            filename = "defs_johannesburg_ecr.json"

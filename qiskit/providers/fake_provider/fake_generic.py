...
class GenericFakeBackend(BackendV2):
    ...
    locally runnable, fake backend. One can configure the number of qubits, basis gates, coupling map,
    ...
    there is always the option to directly instantiate a :class:`.Target` object to use for transpilation.
    """

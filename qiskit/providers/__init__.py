...
backend. For example, a provider service might need to convert from a quantum
circuit and options into a
:mod:`.qpy` payload embedded in JSON before submitting it to a REST API.
Since every backend interface is different (and in the case of the local

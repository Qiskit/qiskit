...
EXPR_TYPE_ARRAY = namedtuple("EXPR_TYPE_ARRAY", ["size"])
EXPR_TYPE_ARRAY_PACK = "!L"
EXPR_TYPE_ARRAY_SIZE = struct.calcsize(EXPR_TYPE_ARRAY_PACK)
...
EXPR_VALUE_ARRAY = namedtuple("EXPR_VALUE_ARRAY", ["num_elems"])
EXPR_VALUE_ARRAY_PACK = "!L"
EXPR_VALUE_ARRAY_SIZE = struct.calcsize(EXPR_VALUE_ARRAY_PACK)

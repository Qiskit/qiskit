...
EXPR_TYPE_STRETCH = namedtuple("EXPR_TYPE_STRETCH", [])
EXPR_TYPE_STRETCH_PACK = "!"
EXPR_TYPE_STRETCH_SIZE = struct.calcsize(EXPR_TYPE_STRETCH_PACK)
...
EXPR_TYPE_FLOAT = namedtuple("EXPR_TYPE_FLOAT", ["const"])
EXPR_TYPE_FLOAT_PACK = "!?"
EXPR_TYPE_FLOAT_SIZE = struct.calcsize(EXPR_TYPE_FLOAT_PACK)

EXPR_TYPE_BOOL_V14 = namedtuple("EXPR_TYPE_BOOL_V14", ["const"])
EXPR_TYPE_BOOL_PACK_V14 = "!?"
EXPR_TYPE_BOOL_SIZE_V14 = struct.calcsize(EXPR_TYPE_BOOL_PACK_V14)

EXPR_TYPE_UINT_V14 = namedtuple("EXPR_TYPE_UINT_V14", ["width", "const"])
EXPR_TYPE_UINT_PACK_V14 = "!L?"
EXPR_TYPE_UINT_SIZE_V14 = struct.calcsize(EXPR_TYPE_UINT_PACK_V14)

...
The ``ANNOTATION_HEADER`` is new in QPY version 15; before that, there was no data between
``REGISTERS`` and ``STANDALONE_VARS``.
...
3. this field is present if and only if the high bit of the ``extras_key`` is set.  This field has
   a variable size; see :ref:`qpy_instructions_annotations_header_v15`.

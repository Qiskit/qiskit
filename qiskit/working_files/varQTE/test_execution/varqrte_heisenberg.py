...
# TODO https://arxiv.org/pdf/1801.03922.pdf Appendix A
    ...
    for k, ode_solver in enumerate(ode_solvers):
        for d in depths:
            for j, reg in enumerate(regs):
                ...
                observable = SummedOp([(I ^ X ^ X), (X ^ X ^ I), (X ^ I ^ X), (I ^ Z ^ Z),
                                      (Z ^ I ^ Z), (Z ^ Z ^ I), 0.1 * (I ^ I ^ Z),
                                       -0.1 * (Z ^ I ^ I), 0.1 * (I ^ Z ^ I)]).reduce()
                # observable = (Y ^ I)
                ...
                parameters = ParameterVector('a', length=9)
                ...
                ansatz.rxx(parameters[3], [0], [1])
                ansatz.rxx(parameters[4], [1], [2])
                ansatz.rxx(parameters[5], [2], [0])
                ansatz.rz(parameters[6], [0])
                ansatz.rz(parameters[7], [1])
                ansatz.rz(parameters[8], [2])
                ...
                print('depth ', d)
                print('---------------------------------------------------------------------')
                varqrte_snapshot_dir = os.path.join('..', 'output_heisenberg', 'real',
                                                    str(nts),
                                                    reg_names[j],

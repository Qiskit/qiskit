...
class CNOTDihedral(BaseOperator, AdjointMixin):
   ...
   **Circuit Conversion**
    ...
    def __init__(self, data=None, num_qubits=None, validate=True):
        ...
        Args:
            data: optional, a CNOTDihedral object, or a QuantumCircuit,
                or ~qiskit.circuit.Instruction, or a ScalarOp or a Pauli operator:
    ...
    def _compose(self, other):
        ...
        result = CNOTDihedral(num_qubits=self.num_qubits)
        result.shift = [(x[0] + x[1]) % 2
                        for x in zip(self._z2matvecmul(other.linear, self.shift), other.shift)]

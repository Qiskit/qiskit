...
class SymmetricOp(ListOp):
    """  A class for efficient representation of symmetric operators, e.g. Hessians or QFI.
    This class holds mapping of operators in ``oplist`` to 2D array.
    This class holds logic to indicate that the Operators in ``oplist`` are meant to

...
class RandomCircuitGenerator(object):
    ...
    def __init__(self, seed=None,
        ...
        self.circuits = []
        self.qreg = QuantumRegister(max_qubits, 'qr')
        self.creg = ClassicalRegister(max_qubits, 'cr')
        self.n_qubit_list = []
        self.depth_list = []
        if seed is not None:
            random.seed(a=seed)
    ...
    def add_circuits(self, n_circuits, do_measure=True):
        """Adds circuits to self.circuits.
    ...
    def get_circuits(self):
        """Return the circuits generated from the generator."""

...
class Gnu95FCompiler(GnuFCompiler):
    ...
    executables = {
        ...
        "compiler_f77": [None, "-Wall", "-g", "-ffixed-form", "-fno-second-underscore"],
        "compiler_f90": [None, "-Wall", "-g", "-fno-second-underscore"],
        "compiler_fix": [None, "-Wall", "-g", "-ffixed-form", "-fno-second-underscore"],
        ...
        if self.c_compiler.compiler_type == "msvc":
            ...
            for archive in archives[::-1]:
                lib, dll = self._link_wrapper_lib(
                    [archive], output_dir, extra_dll_dir, chained_dlls=chained_dlls, is_archive=True
                )

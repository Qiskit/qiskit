...
rout_rules = [
    ...
    {  # Subroutine
        ...
        "routine_def": {
            ...
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
            l_and(l_not(ismoduleroutine), isdummyroutine): '    {"#name#",-1,{{-1}},0,0,NULL,'
            "  (f2py_init_func)#apiname#,doc_#apiname#},",
        },
    ...
    {  # Wrapped function
        ...
        "routine_def": {
            l_not(l_or(ismoduleroutine, isdummyroutine)): '    {"#name#",-1,{{-1}},0,0,(char *)'
...
"""
    ...
    {  # String function # in use for --no-wrap
        ...
        "decl": ["    #ctype# #name#_return_value = NULL;", "    int #name#_return_value_len = 0;"],
...
aux_rules = [
    ...
    # Integer*-1 array
    {"need": "#ctype#", "_check": l_or(isunsigned_chararray, isunsigned_char), "_depend": ""},
    # Integer*-2 array
...
arg_rules = [
    ...
    {"docreturn": "#outvarname#,", "returnformat": "#varrformat#", "_check": isintent_out},
...
def buildmodule(m, um):
    ...
    needs["typedefs"] += [
        cvar for cvar in capi_maps.f2cmap_mapped if cvar in typedef_need_dict.values()  #
    ]
    code = {}
    for n in needs.keys():
        code[n] = []

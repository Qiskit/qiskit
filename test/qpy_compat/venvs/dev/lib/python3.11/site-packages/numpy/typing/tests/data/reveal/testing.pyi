...
assert_type(
    np.testing.tempdir("test_dir", dir=Path("here")), contextlib._GeneratorContextManager[str]
)
...
assert_type(
    np.testing.temppath("test_dir", dir=Path("here")), contextlib._GeneratorContextManager[str]
)

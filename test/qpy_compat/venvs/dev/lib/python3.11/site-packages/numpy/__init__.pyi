...
class dtype(Generic[_DTypeScalar_co]):
    ...
    def descr(
        self,
    ) -> list[tuple[builtins.str, builtins.str] | tuple[builtins.str, builtins.str, _Shape]]: ...
    @property
    def fields(
        self,
    ) -> (
...
class _ArrayOrScalarCommon:
    ...
    def dump(
        self, file: str | bytes | os.PathLike[str] | os.PathLike[bytes] | _SupportsWrite[bytes]
    ) -> None: ...
...
class recarray(ndarray[_ShapeType, _DType_co]):
    ...
    @overload
    def __getitem__(
        self, indx: SupportsIndex | _ArrayLikeInt_co | tuple[SupportsIndex | _ArrayLikeInt_co, ...]
    ) -> Any: ...
    @overload
    def __getitem__(
...
class matrix(ndarray[_ShapeType, _DType_co]):
    ...
    @overload
    def sum(
        self, axis: None | _ShapeLike = ..., dtype: DTypeLike = ..., out: _NdArraySubClass = ...
    ) -> _NdArraySubClass: ...
    @overload

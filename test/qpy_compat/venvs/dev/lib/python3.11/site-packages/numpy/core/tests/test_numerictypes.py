...
Ndescr = [
    ...
    (
        ...
        [
            ...
            (
                "Info2",
                [("name", "S2"), ("value", "c16", (2,)), ("y3", "f8", (2,)), ("z3", "u4", (2,))],
            ),
            ("name", "S2"),
            ("z2", "b1"),
        ],
...
NbufferT = [
    ...
    (
        [3, 2],
        (6j, 6.0, (b"nn", [6j, 4j], [6.0, 4.0], [1, 2]), b"NN", True),
        b"cc",
        ("NN", 6j),
        [[6.0, 4.0], [6.0, 4.0]],
        8,
    ...
    (
        [4, 3],
        (7j, 7.0, (b"oo", [7j, 5j], [7.0, 5.0], [2, 1]), b"OO", False),
        b"dd",
        ("OO", 7j),
        [[7.0, 5.0], [7.0, 5.0]],
        9,
...
class ReadValuesNested:
    ...
    def test_nested1_acessors(self):
        ...
        if not self.multiple_rows:
            ...
            assert_equal(
                h["Info"]["value"],
                np.array([self._buffer[0][1][0], self._buffer[1][1][0]], dtype="c16"),
            )
            assert_equal(
                h["Info"]["y2"],
                np.array([self._buffer[0][1][1], self._buffer[1][1][1]], dtype="f8"),
            )
            assert_equal(
                h["info"]["Name"],
                np.array([self._buffer[0][3][0], self._buffer[1][3][0]], dtype="U2"),
            )
            assert_equal(
                h["info"]["Value"],
                np.array([self._buffer[0][3][1], self._buffer[1][3][1]], dtype="c16"),
            )

...
if os.name == "nt":
    ...
    def memusage(processName="python", instance=0):
        ...
        return GetPerformanceAttributes(
            "Process", "Virtual Bytes", processName, instance, win32pdh.PDH_FMT_LONG, None
        )
...
def assert_array_compare(
    ...
    *,
    ...
    __tracebackhide__ = True  # Hide traceback for py.test
    from numpy.core import array2string, isnan, inf, bool_, errstate, all, max, object_
    ...
    try:
        ...
        msg = build_err_msg(
            [x, y], err_msg, verbose=verbose, header=header, names=("x", "y"), precision=precision
        )
    ...
    if n_objects_in_cycles:
        ...
        raise AssertionError(
            ...
            "of which {} are shown below:{}".format(
                ...
                "".join(
                    "\n  {} object with id={}:\n    {}".format(
                        type(o).__name__, id(o), pprint.pformat(o).replace("\n", "\n    ")
                    )

...
@pytest.mark.parametrize(
    ...
    (
        ...
        (array([Decimal("1.00"), Decimal("2.2"), 3], dtype=object), ("1.00 + 2.2·x + 3·x²")),
    ),
)
...
class TestLatexRepr:
    ...
    def test_basis_func(self):
        ...
        assert_equal(
            self.as_latex(p), r"$x \mapsto 1.0\,{T}_{0}(x) + 2.0\,{T}_{1}(x) + 3.0\,{T}_{2}(x)$"
        )
    ...
    def test_multichar_basis_func(self):
        ...
        assert_equal(
            self.as_latex(p), r"$x \mapsto 1.0\,{He}_{0}(x) + 2.0\,{He}_{1}(x) + 3.0\,{He}_{2}(x)$"
        )
...
class TestPrintOptions:
    ...
    def test_str(self):
        ...
        assert_equal(
            str(p), "0.5 + 0.14285714 x + 14285714.28571429 x**2 " "+ (1.42857143e+08) x**3"
        )

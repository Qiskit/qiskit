...
def test_hyper_misc():
    ...
    assert hyp2f1((2, 3), (1, 1), (3, 2), (2 + j) / 3).ae(
        1.327531603558679093 + 0.439585080092769253j
    )
    mp.dps = 25
...
def test_ei():
    ...
    assert shi(-(10**6) + 100j).ae(
        "-1.3077239389562548386e+434288 - 7.6808956999707408158e+434287j"
    )
    mp.dps = 15
...
def test_hyper_1f1():
    ...
    # Bug
    assert hyp1f1(1j, fraction(1, 3), 0.415 - 69.739j).ae(
        25.857588206024346592 + 15.738060264515292063j
    )
...
def test_hyper_2f1_hard():
    ...
    assert hyp2f1(112, (51, 10), (-9, 10), -0.99999).ae(
        -1.6241361047970862961e-24, abs_eps=0, rel_eps=eps * 16
    )
...
def test_hyper_3f2_etc():
    ...
    assert hyper([1, 2, 3, 4, 5], [6, 7, 8, 9], 5).ae(
        1.33980653631074769423 - 0.07143405251029226699j
    )
    assert hyper([1, 2.79, 3.08, 4.37], [5.2, 6.1, 7.3], 5).ae(
        1.0996321464692607231 - 1.7748052293979985001j
    )
...
def test_hyper_u():
    ...
    assert (hyperu((3, 2), 8, 100 + 201j) * 10**4).ae(
        -0.3797318333856738798 - 2.9974928453561707782j
    )
...
def test_hyper_1f2():
    ...
    assert hyp1f2(a1, b1, b2, 1000000 * j).ae(
        "3.5999042951925965458e+613 + 1.5026014707128947992e+613j"
    )
    assert hyp1f2(a1, b1, b2, 10**7 * j).ae(
        "-8.3208715051623234801e+1939 - 3.6752883490851869429e+1941j"
    )
    assert hyp1f2(a1, b1, b2, 10**8 * j).ae(
...
def test_hyper_2f3():
    ...
    assert hyp2f3(a1, a2, b1, b2, b3, 10000 * j).ae(
        -1.1779696326238582496e59 + 1.2297607505213133872e59j
    )
    assert hyp2f3(a1, a2, b1, b2, b3, 100000 * j).ae(
        2.9844228969804380301e191 + 7.5587163231490273296e190j
    )
    assert hyp2f3(a1, a2, b1, b2, b3, 1000000 * j).ae(
        "7.4859161049322370311e+610 - 2.8467477015940090189e+610j"
    )
    assert hyp2f3(a1, a2, b1, b2, b3, 10**7 * j).ae(
        "-1.7477645579418800826e+1938 - 1.7606522995808116405e+1938j"
    )
    assert hyp2f3(a1, a2, b1, b2, b3, 10**8 * j).ae(
        "-1.6932731942958401784e+6137 - 2.4521909113114629368e+6137j"
    )
...
def test_hermite():
    ...
    assert hermite(-9.5, 100j).ae(
        -9.7900218581864768430e-23 - 9.7900218581864768430e-23j, abs_eps=0, rel_eps=eps
    )
    assert hermite(-9.5, -100j).ae(
        -9.7900218581864768430e-23 + 9.7900218581864768430e-23j, abs_eps=0, rel_eps=eps
    )
...
def test_gammainc():
    ...
    assert gammainc(-3.5, -200.5).ae(
        0.27008820585226911 - 5.3264597096208368435e76j
    )  # XXX real part
    ...
    assert gammainc(2 + 3j, 4 + 5j, regularized=True).ae(
        0.085422013530993285774 - 0.052595379150390078503j
    )
    assert gammainc(1000j, 1000j, regularized=True).ae(
        0.49702647628921131761 + 0.00297355675013575341j
    )
    # Generalized
...
def test_gammainc_expint_n():
    ...
    assert expint(-3, -350000000000000000000000).ae(
        "-3.7805306852415755699e+152003068666138139677871"
    )
    assert expint(-2, -350000000000000000000000).ae(
        "-3.7805306852415755699e+152003068666138139677871"
    )
    ...
    assert u.imag.ae(-3.1415926535897932385)
    assert gammainc(1, -350000000000000000000000).ae(
        "1.3231857398345514495e+152003068666138139677895"
    )
    assert gammainc(2, -350000000000000000000000).ae(
        "-4.6311500894209300731e+152003068666138139677918"
    )
    assert gammainc(3, -350000000000000000000000).ae(
        "1.6209025312973255256e+152003068666138139677942"
    )
...
def test_incomplete_beta():
    ...
    assert betainc(4.5, 0.5 + 2j, 2.5, 6).ae(
        0.2628801146130621387903065 + 0.5162565234467020592855378j
    )
...
def test_erf():
    ...
    assert erf(erfinv(-0.999999999995)).ae(-0.999999999995)
    mp.dps = 50
    assert erf(erfinv("0.99999999999999999999999999999995")).ae(
        "0.99999999999999999999999999999995"
    )
    assert erf(erfinv("0.999999999999999999999999999999995")).ae(
...
def test_lambertw_hard():
    ...
    assert check(
        lambertw(addj(a, d10)), -0.9999835127872943680999899 + 0.0000164870314895821225256j
    )
    ...
    assert check(
        lambertw(subj(a, d10)), -0.9999835127872943680999899 - 0.0000164870314895821225256j
    )
    ...
    # ---- Branch 1 ----
    assert check(
        lambertw(addj(a, d3), 1), -3.088501303219933378005990 + 7.458676867597474813950098j
    )
    assert check(
        lambertw(addj(a, d80), 1), -3.088843015613043855957087 + 7.461489285654254556906117j
    )
    assert check(
        lambertw(addj(a, d300), 1), -3.088843015613043855957087 + 7.461489285654254556906117j
    )
    assert check(
        lambertw(addj(a, d1000), 1), -3.088843015613043855957087 + 7.461489285654254556906117j
    )
    assert check(
        lambertw(subj(a, d3), 1), -1.0520914180450129534365906 + 0.0539925638125450525673175j
    )
    assert check(
        lambertw(subj(a, d10), 1), -1.0000164872127056318529390 + 0.000016487393927159250398333077j
    )
    assert check(
        lambertw(subj(a, d20), 1), -1.0000000001648721270700128 + 1.64872127088134693542628e-10j
    )
    assert check(
        lambertw(subj(a, d40), 1), -1.000000000000000000016487 + 1.64872127070012814686677e-20j
    )
    ...
    assert check(
        lambertw(sub(a, d10), -1), -0.9999999998187812114595992 - 0.0000233164398140346109194j
    )
    assert check(
        lambertw(sub(a, d20), -1), -0.99999999999999999998187 - 2.331643981597124203344e-10j
    )
    ...
    # -1/e + eps*j
    assert check(
        lambertw(addj(a, d3), -1), -1.0520914180450129534365906 - 0.0539925638125450525673175j
    )
    assert check(
        lambertw(addj(a, d10), -1), -1.0000164872127056318529390 - 0.0000164873939271592503983j
    )
    assert check(
        lambertw(addj(a, d20), -1), -1.0000000001648721270700 - 1.64872127088134693542628e-10j
    )
    assert check(
        lambertw(addj(a, d40), -1), -1.00000000000000000001648 - 1.6487212707001281468667726e-20j
    )
    ...
    # -1/e - eps*j
    assert check(
        lambertw(subj(a, d3), -1), -3.088501303219933378005990 - 7.458676867597474813950098j
    )
    assert check(
        lambertw(subj(a, d10), -1), -3.088843015579260686911033 - 7.461489285372968780020716j
    )
    assert check(
        lambertw(subj(a, d20), -1), -3.088843015613043855953708 - 7.461489285654254556877988j
    )
    assert check(
        lambertw(subj(a, d40), -1), -3.088843015613043855957087 - 7.461489285654254556906117j
    )
    assert check(
        lambertw(subj(a, d80), -1), -3.088843015613043855957087 - 7.461489285654254556906117j
    )
    assert check(
        lambertw(subj(a, d300), -1), -3.088843015613043855957087 - 7.461489285654254556906117j
    )
    assert check(
        lambertw(subj(a, d1000), -1), -3.088843015613043855957087 - 7.461489285654254556906117j
    )
...
def test_meijerg():
    ...
    assert meijerg([[], [1 + j]], [[1], [1]], 3 + 4j).ae(
        271.46290321152464592 - 703.03330399954820169j
    )
    ...
    assert meijerg([[1 - (-1)], [1 - (-2.5)]], [[1 - (-3)], [1 - (-0.5)]], -2.0).ae(
        -1.338096165935754898687431
    )
...
def test_spherharm():
    ...
    assert spherharm(2 + 3j, 1 - j, 1 + j, 3 + 4j).ae(
        -2.6582752037810116935 - 1.0909214905642160211j
    )

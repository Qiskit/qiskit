...
def main():
    ...
    subparsers = parser.add_subparsers(
        title="commands", description="valid commands", help="additional help", dest="cmd"
    )
    ...
    cmd_info.add_argument("-s", "--short", action="store_true", help="only display package version")

...
int test_parameter_binary_ops(void) {
    ...
    qk_param_free(ret);
    if (strcmp(str, "a+b") != 0) {
        printf("qk_param_add %s is not a+b", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        return EqualityError;
    ...
    qk_param_free(ret);
    if (strcmp(str, "a-b") != 0) {
        printf("qk_param_sub %s is not a-b", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        return EqualityError;
    ...
    qk_param_free(ret);
    if (strcmp(str, "a*b") != 0) {
        printf("qk_param_mul %s is not a*b", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        return EqualityError;
    ...
    qk_param_free(ret);
    if (strcmp(str, "a/b") != 0) {
        printf("qk_param_div %s is not a/b", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        return EqualityError;
    ...
    qk_param_free(ret);
    if (strcmp(str, "a**b") != 0) {
        printf("qk_param_pow %s is not a**b", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        return EqualityError;
...
int test_parameter_unary_ops(void) {
    ...
    if (strcmp(str, "sin(a+b)") != 0) {
        printf("qk_param_sin %s is not sin(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "cos(a+b)") != 0) {
        printf("qk_param_cos %s is not cos(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "tan(a+b)") != 0) {
        printf("qk_param_tan %s is not tan(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "asin(a+b)") != 0) {
        printf("qk_param_asin %s is not asin(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "acos(a+b)") != 0) {
        printf("qk_param_acos %s is not acos(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "atan(a+b)") != 0) {
        printf("qk_param_atan %s is not atan(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "log(a+b)") != 0) {
        printf("qk_param_log %s is not log(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "exp(a+b)") != 0) {
        printf("qk_param_exp %s is not exp(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "abs(a+b)") != 0) {
        printf("qk_param_abs %s is not abs(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "sign(a+b)") != 0) {
        printf("qk_param_sign %s is not sign(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    qk_param_free(ret);
    if (strcmp(str, "-(a+b)") != 0) {
        printf("qk_param_neg %s is not -(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
    ...
    if (strcmp(str, "conj(a+b)") != 0) {
        printf("qk_param_conj %s is not conj(a+b)", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(b);
        qk_param_free(c);
...
int test_parameter_with_value(void) {
    ...
    if (strcmp(str, "2.5+a") != 0) {
        printf("qk_param_add %s is not 2.5+a", str);
        qk_str_free(str);
        qk_param_free(a);
        qk_param_free(v);
        return EqualityError;

 ...
 * Test running the path with no elision.
 */
static int test_dag_elide_permutations_no_result(void) {
    const uint32_t num_qubits = 5;
 ...
 * Test running the path with no elision.
 */
static int test_dag_elide_permutations_swap_result(void) {
    QkDag *dag = qk_dag_new();
...
int test_elide_permutations(void) {
    ...
    num_failed += RUN_TEST(test_dag_elide_permutations_no_result);
    num_failed += RUN_TEST(test_dag_elide_permutations_swap_result);

...
int test_compose(void) {
    ...
    QkComplex64 coeff1 = CMPLX(1.0, 0.0);
    ...
    QkComplex64 coeff2 = CMPLX(2.0, 0.0);
    ...
    QkComplex64 expected_coeff = CMPLX(0.0, 2.0);
...
int test_compose_scalar(void) {
    ...
    QkComplex64 coeff = CMPLX(1.0, 0.0);
    ...
    QkComplex64 factor = CMPLX(2.0, 0.0);
 ...
 */
int test_mult(void) {
    QkComplex64 coeffs[3] = {CMPLX(2.0, 0.0), CMPLX(0.0, 2.0), CMPLX(2.0, 2.0)};
...
int test_canonicalize(void) {
    ...
    QkBitTerm bit_terms[] = {};
    uint32_t indices[] = {};
    QkComplex64 coeff = CMPLX(2.0, 0.0);
...
int test_term(void) {
    ...
    QkComplex64 coeff = CMPLX(1.0, 1.0);
...
int test_copy_term(void) {
    ...
    QkComplex64 coeff2 = CMPLX(0.0, 2.0);
    copied_indices[1] = 99;
...
int test_direct_build(void) {
    ...
    QkComplex64 coeffs[2] = {CMPLX(1.0, 0.0), CMPLX(-1.0, 0.0)};

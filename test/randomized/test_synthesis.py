...
class TestSynthesis(CheckDecompositions):
    ...
    def test_1q_random(self, seed):
        ...
        self.check_one_qubit_euler_angles(unitary, phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'U3',  phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'U1X', phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'PSX', phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'ZSX', phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'ZYZ', phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'ZXZ', phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'XYX', phase_equal=True)
        self.check_one_qubit_euler_angles(unitary, 'RR',  phase_equal=True)

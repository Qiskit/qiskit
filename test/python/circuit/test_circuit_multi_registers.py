...
class TestCircuitMultiRegs(QiskitTestCase):
    ...
    def test_circuit_multi(self):
        ...
        backend_sim = Simulators.get_backend('qasm_simulator_py')
        ...
        backend_sim = Simulators.get_backend('statevector_simulator_py')
        result = backend_sim.run(qobj_circ).result()
        state_py = result.get_statevector(circ)

        backend_sim = Simulators.get_backend('unitary_simulator_py')
        result = backend_sim.run(qobj_circ).result()

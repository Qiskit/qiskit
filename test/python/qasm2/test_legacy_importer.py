...
class LoadFromQasmTest(QiskitTestCase):
    ...
    def test_qasm_file(self):
        ...
        """
        q_circuit = self.from_qasm_file(self.qasm_file_path)
    ...
    def test_loading_all_qelib1_gates(self):
        ...
        qasm_circuit = self.from_qasm_file(all_gates_qasm)
    ...
    def test_fail_qasm_file(self):
        ...
        """
        self.assertRaises(QiskitError, self.from_qasm_file, "")
    ...
    def test_qasm_text(self):
        ...
        q_circuit = self.from_qasm_str(qasm_string)
    ...
    def test_opaque_gate(self):
        ...
        circuit = self.from_qasm_str(qasm_string)
    ...
    def test_qasm_example_file(self):
        ...
        expected_circuit = self.from_qasm_str(
            "\n".join(
                [
                    "OPENQASM 2.0;",
                    'include "qelib1.inc";',
        ...
        q_circuit = self.from_qasm_file(qasm_filename)

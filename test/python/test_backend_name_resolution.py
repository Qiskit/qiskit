...
from qiskit import IBMQ, BasicSimulators, LegacySimulators
...
class TestBackendNameResolution(QiskitTestCase):
    ...
    def test_deprecated(self):
        ...
        """
        for provider in (BasicSimulators, LegacySimulators):
    ...
    def test_aliases_fail(self):
        ...
        self.assertRaises(QiskitBackendNotFoundError, BasicSimulators.get_backend, 'bad_name')

    def test_aliases_return_empty_list(self):
        """Test backends() return an empty list if name is unknown."""
        self.assertEqual(BasicSimulators.backends("bad_name"), [])

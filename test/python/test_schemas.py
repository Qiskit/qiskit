...
import json
import os
from qiskit import (validate_json_against_schema, _create_validator)
...
class TestSchemaExamples(QiskitTestCase):
    ...
    def setUp(self):
        self.schema_tests = []
        self.schema_tests.append(
            {"schema_name": "backend_configuration",
             "examples": [
        ...
        self.schema_tests.append(
            {"schema_name": "backend_properties",
             "examples": [
                 "backend_properties_example.json"]})
        self.schema_tests.append(
            {"schema_name": "backend_status",
             "examples": [
                 "backend_status_example.json"]})
        self.schema_tests.append(
            {"schema_name": "default_pulse_configuration",
             "examples": [
                 "default_pulse_configuration_example.json"]})
        self.schema_tests.append(
            {"schema_name": "job_status",
             "examples": [

...
class TestStabilizerState(QiskitTestCase):
    ...
    def test_probablities_dict_single_qubit(self):
        ...
        # Same Tests as above but with Targets
        qc = QuantumCircuit(num_qubits)
        for _ in range(self.samples):
            with self.subTest(msg="P(id(0))"):
                stab = StabilizerState(qc)
    ...
    def test_probablities_dict_qubits(self):
        ...
        self.assertTrue(test_2_1_time_with_targets < test_1_time_no_target)        
        ...
        #test as above with target and 2 not close branches, requiring 24 node calculations

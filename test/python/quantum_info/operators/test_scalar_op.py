...
class TestScalarOp(QiskitTestCase):
    """Tests for ScalarOp class."""
    ...
    def test_tensor_scalar(self):
        """Test tensor and expand methods with two ScalarOp."""
    ...
    def test_tensor_operator(self):
        """Test tensor and expand methods with ScalarOp and Operator."""
    ...
    def test_compose_scalar(self):
        """Test compose and dot methods with two ScalarOp."""
        # Add two ScalarOps
        for coeff1 in [None, 1, -3.1, 1 + 3j]:
            for coeff2 in [None, -1, -5.1 - 2j]:
                dims = (3, 2)
    ...
    def test_compose_qargs_scalar(self):
        """Test qargs compose and dot methods with two ScalarOp."""
        # Add two ScalarOps
        for coeff1 in [None, 1, -3.1, 1 + 3j]:
            for coeff2 in [None, -1, -5.1 - 2j]:
                dims = (2, 3)

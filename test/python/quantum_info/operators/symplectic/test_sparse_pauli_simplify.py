...
class TestSparsePauliOpUnitary(unittest.TestCase):
    ...
    def test_is_unitary_with_tolerance(self):
        ...
        self.assertTrue(
            pauli_op.is_unitary(atol=test_atol, rtol=test_rtol),
    ...
    def test_is_unitary_strict_tolerance(self):
        ...
        self.assertFalse(
            non_unitary_op.is_unitary(), "Expected non-unitary operator to be identified as such."
        )
        self.assertFalse(
            non_unitary_op.is_unitary(atol=1e-10, rtol=1e-10),

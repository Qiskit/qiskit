...
class TestPulseVisualizationImplementation(QiskitVisualizationTestCase):
    ...
    def sample_schedule(self):
        ...
        sched = sched.insert(
            0, Play(library.Constant(duration=60, amp=0.2 + 0.4j), ControlChannel(0))
        )
        ...
        sched = sched.insert(90, Acquire(10, AcquireChannel(1), MemorySlot(1), RegisterSlot(1)))
    ...
    def test_truncate_acquisition(self):
        sched = Schedule(name="test_schedule")
        sched = sched.insert(0, Acquire(30, AcquireChannel(1), MemorySlot(1), RegisterSlot(1)))

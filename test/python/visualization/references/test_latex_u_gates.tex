...
\begin{equation*}
    \Qcircuit @C=1.0em @R=0.2em @!R {
	 	...
	 	\lstick{ {q}_{1} :  } & \gate{\mathrm{U}_2\,\mathrm{(}\mathrm{\frac{3\pi}{2}},\mathrm{\frac{2\pi}{3}}\mathrm{)}} & \control \qw \cds{-1}{\settowidth{\glen}{\ensuremath{\mathrm{U}_1\,\mathrm{(}\mathrm{\frac{\pi}{4}}\mathrm{)}}} \hspace{0.5em}\hspace{\glen}\ensuremath{\mathrm{U}_1\,\mathrm{(}\mathrm{\frac{\pi}{4}}\mathrm{)}}} & \qw & \qw & \qw & \gate{\mathrm{U}_3\,\mathrm{(}\mathrm{\frac{3\pi}{2}},\mathrm{\frac{-3\pi}{4}},\mathrm{\frac{-\pi}{2}}\mathrm{)}} & \qw & \qw\\

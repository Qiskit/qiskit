...
\Qcircuit @C=1.0em @R=0.2em @!R { \\
	 	...
	 	\nghost{ {q}_{1} :  } & \lstick{ {q}_{1} :  } & \gate{\mathrm{U_2}\,(\mathrm{\frac{3\pi}{2},\frac{2\pi}{3}})} & \control \qw \cds{-1}{\settowidth{\glen}{\ensuremath{\mathrm{U_1}\,(\mathrm{\frac{\pi}{4}})}} \hspace{0.5em}\hspace{\glen}\ensuremath{\mathrm{U_1}\,(\mathrm{\frac{\pi}{4}})}} & \qw & \qw & \qw & \qw & \gate{\mathrm{U_3}\,(\mathrm{\frac{3\pi}{2},\frac{-3\pi}{4},\frac{-\pi}{2}})} & \qw & \qw\\ 

...
\Qcircuit @C=1.0em @R=0.2em @!R { \\
         ...
         \nghost{{c}_{1} :  } & \lstick{{c}_{1} :  } & \cw & \control \cw \cwx[-1] & \cw & \cw\\
         \nghost{{c}_{2} :  } & \lstick{{c}_{2} :  } & \cw & \controlo \cw \cwx[-1] & \cw & \cw\\
         \nghost{{c}_{3} :  } & \lstick{{c}_{3} :  } & \cw & \control \cw^(0.0){^{\mathtt{0xa}}} \cwx[-1] & \cw & \cw\\

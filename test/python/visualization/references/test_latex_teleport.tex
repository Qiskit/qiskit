...
\Qcircuit @C=1.0em @R=0.2em @!R { \\
	 	...
	 	\nghost{c:} & \lstick{c:} & \lstick{/_{_{3}}} \cw & \cw & \cw & \cw & \dstick{_{_{1}}} \cw \ar @{<=} [-2,0] & \dstick{_{_{0}}} \cw \ar @{<=} [-3,0] & \dstick{_{_{=1}}} \cw \cwx[-1] & \dstick{_{_{=2}}} \cw \cwx[-1] & \dstick{_{_{2}}} \cw \ar @{<=} [-1,0] & \cw & \cw\\ 
\\ }}
\end{document}
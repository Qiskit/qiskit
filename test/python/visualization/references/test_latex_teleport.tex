...
\begin{equation*}
    \Qcircuit @C=1.0em @R=0.2em @!R {
	 	...
	 	\lstick{c:} & {/_{_{3}}} \cw & \cw & \cw & \cw & \dstick{\mathrm{1}} \cw \cwx[-2] & \dstick{\mathrm{0}} \cw \cwx[-3] & \dstick{\mathrm{1}} \cw \cwx[-1] & \dstick{\mathrm{2}} \cw \cwx[-1] & \dstick{\mathrm{2}} \cw \cwx[-1] & \cw & \cw\\
	 }
\end{equation*}

...
\begin{equation*}
    \Qcircuit @C=1.0em @R=0.2em @!R {
	 	...
	 	\lstick{ {q}_{4} :  } & \qw & \qw & \ctrlo{-1} \cds{-1}{\settowidth{\glen}{\ensuremath{\mathrm{ZZ}\,\mathrm{(}\mathrm{\frac{3\pi}{4}}\mathrm{)}}} \hspace{0.5em}\hspace{\glen}\ensuremath{\mathrm{ZZ}\,\mathrm{(}\mathrm{\frac{3\pi}{4}}\mathrm{)}}} & \qw & \qw & \qw & \qw & \qw\\
	 }
\end{equation*}

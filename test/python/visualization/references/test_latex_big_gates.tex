...
\Qcircuit @C=1.0em @R=1.0em @!R { \\
	 	...
	 	\nghost{{q}_{3} :  } & \lstick{{q}_{3} :  } & \multigate{2}{|\psi\rangle}_<<<{0} & \multigate{1}{\mathrm{Isometry}}_<<<{0} & \qw & \qw\\
	 	\nghost{{q}_{4} :  } & \lstick{{q}_{4} :  } & \ghost{|\psi\rangle}_<<<{1} & \ghost{\mathrm{Isometry}}_<<<{1} & \qw & \qw\\
	 	\nghost{{q}_{5} :  } & \lstick{{q}_{5} :  } & \ghost{|\psi\rangle}_<<<{2} & \qw & \qw & \qw\\
\\ }}
\end{document}
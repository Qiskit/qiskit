...
\begin{equation*}
    \Qcircuit @C=1.0em @R=0.2em @!R {
	 	...
	 	\lstick{ {q}_{6} :  } & \control\qw & \control \qw $\cds{-1}{\hspace{3.2em}\mathrm{U}_1\,\mathrm{(}\mathrm{\frac{\pi}{2}}\mathrm{)}}$ & \qw & \qw & \qw & \qw & \qw & \ghost{\mathrm{R}_{\mathrm{ZX}}\,\mathrm{(}\mathrm{\frac{\pi}{2}}\mathrm{)}} & \qw & \qw & \qw & \qw & \qw & \qw & \qw\\
	 }
\end{equation*}

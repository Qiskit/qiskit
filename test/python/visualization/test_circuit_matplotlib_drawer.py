...
class TestMatplotlibDrawer(QiskitVisualizationTestCase):
    ...
    def test_plot_barriers(self):
        ...
        visualization.circuit_drawer(qc, output='mpl', plot_barriers=True,scale = 1, filename=filename)
        self.addCleanup(os.remove, filename)
    ...
    def test_conditional(self):
        ...
        visualization.circuit_drawer(circuit, output='mpl', scale = 1, filename=conditional_filename)

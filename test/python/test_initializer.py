...
from qiskit import execute, BasicSimulators
...
class TestInitialize(QiskitTestCase):
    ...
    def test_uniform_superposition(self):
        ...
        job = execute(qc, BasicSimulators.get_backend('statevector_simulator'))
        result = job.result()
    ...
    def test_initialize_middle_circuit(self):
        ...
        job = execute(qc, BasicSimulators.get_backend('qasm_simulator'), shots=shots)
        result = job.result()
    ...
    def test_combiner(self):
        ...
        job = execute(qc1 + qc2, BasicSimulators.get_backend('statevector_simulator'))
        result = job.result()

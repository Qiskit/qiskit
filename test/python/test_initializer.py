...
class TestInitialize(QiskitTestCase):
    ...
    def test_uniform_superposition(self):
        ...
        job = wrapper.execute(qc, backend_name='local_statevector_simulator')
        result = job.result()
    ...
    def test_initialize_middle_circuit(self):
        ...
        job = wrapper.execute(qc, backend_name='local_qasm_simulator',
    ...
    def test_combiner(self):
        ...
        job = wrapper.execute(qc1+qc2, backend_name='local_statevector_simulator')
        result = job.result()

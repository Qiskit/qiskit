...
class TestInitialize(QiskitTestCase):
    ...
    def test_uniform_superposition(self):
        ...
        job = wrapper.execute(qc, Aer.get_backend('statevector_simulator'))
        result = job.result()
    ...
    def test_initialize_middle_circuit(self):
        ...
        job = wrapper.execute(qc, Aer.get_backend('qasm_simulator'), shots=shots)
        result = job.result()
    ...
    def test_combiner(self):
        ...
        job = wrapper.execute(qc1+qc2, Aer.get_backend('statevector_simulator'))
        result = job.result()

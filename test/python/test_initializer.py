...
from qiskit import execute, AerPy
...
class TestInitialize(QiskitTestCase):
    ...
    def test_initialize_middle_circuit(self):
        ...
        job = execute(qc, AerPy.get_backend('qasm_simulator'), shots=shots)
        result = job.result()
    ...
    def test_combiner(self):
        ...
        job = execute(qc1+qc2, AerPy.get_backend('statevector_simulator'))
        result = job.result()

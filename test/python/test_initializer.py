...
from qiskit import execute, Simulators
...
class TestInitialize(QiskitTestCase):
    ...
    def test_uniform_superposition(self):
        ...
        job = execute(qc, Simulators.get_backend('statevector_simulator_py'))
        result = job.result()
    ...
    def test_initialize_middle_circuit(self):
        ...
        job = execute(qc, Simulators.get_backend('qasm_simulator_py'), shots=shots)
        result = job.result()
    ...
    def test_combiner(self):
        ...
        job = execute(qc1 + qc2, Simulators.get_backend('statevector_simulator_py'))
        result = job.result()

...
class TestJupyter(QiskitTestCase):
    ...
    def test_jupyter_jobs_pbars(self):
        ...
        self._execute_notebook(self._get_resource_path("notebooks/test_pbar_status.ipynb"))

    @unittest.skipIf(not HAS_MATPLOTLIB, "matplotlib not available.")
    @slow_test
    def test_backend_tools(self):
        """Test Jupyter backend tools."""
        self._execute_notebook(self._get_resource_path("notebooks/test_backend_tools.ipynb"))

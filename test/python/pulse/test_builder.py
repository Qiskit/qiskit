...
from qiskit.pulse.transforms import target_qobj_transform, inline_subroutines
...
class TestSubroutineWithCXGate(QiskitTestCase):
    """Test called program scope with practical example."""
    ...
    def test_indirect_reference(self):
        """Test deeply nested schedule."""
        with pulse.build(name="grand_child") as sched1:
    ...
    def test_direct_reference(self):
        """Test nesting schedules without calling."""
        with pulse.build(name="grand_child") as sched1:
            pulse.call(self.xp_sched)

        sched2 = pulse.ScheduleBlock(name="child")

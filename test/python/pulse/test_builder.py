...
class TestBuilderFrames(TestBuilder):
    ...
    def test_simple_frame_schedule(self):
        ...
        signal = pulse.Signal(pulse.Gaussian(160, 0.1, 40), pulse.Frame("Q", 0))
    ...
    def test_ignore_frames(self):
        ...
        self.assertEqual(sched.instructions[2][1], pulse.ShiftPhase(1.57, pulse.Frame("Q", 0)))
        self.assertEqual(sched.instructions[3][0], 320)
        self.assertEqual(sched.instructions[3][1], pulse.ShiftPhase(1.57, pulse.Frame("Q", 1)))

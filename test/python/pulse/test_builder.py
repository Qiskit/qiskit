...
from qiskit.providers.fake_provider import FakeOpenPulse2Q, FakeMumbaiV2
...
class TestUtilitiesV2(TestBuilderV2, TestUtilities):
    """Test builder utilities with backendV2."""
...
class TestMacrosV2(TestBuilderV2, TestMacros):

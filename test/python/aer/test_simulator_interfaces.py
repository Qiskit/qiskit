...
from qiskit import StaleAer, IBMQ, AerPy
...
class TestCrossSimulation(QiskitTestCase):
    ...
    def test_statevector(self):
        ...
        sim_cpp = StaleAer.get_backend('statevector_simulator')
        sim_py = AerPy.get_backend('statevector_simulator')
    ...
    def test_qasm(self):
        ...
        sim_cpp = StaleAer.get_backend('qasm_simulator')
        sim_py = AerPy.get_backend('qasm_simulator')
        shots = 2000

...
class TestVarQRTE(QiskitAlgorithmsTestCase):
    ...
    #         ["Z", "I"],
    #         np.array([E1, E0*Parameter.exp(t_param/w0)]),
    #     )
    #     print(observable)
    #     # initial state |1>
    #     # target state ground state of Z
    #     theta1, phi1, lam1 = Parameter("theta1"), Parameter("phi1"), Parameter("lam1")
    #     ansatz = QuantumCircuit(1)
    #     ansatz.u(theta1, phi1, lam1, 0)
    #
    #     parameters = list(ansatz.parameters)
    #     print(parameters)
    #     init_param_values = np.zeros(len(parameters))
    ...
    #     lam1 = np.pi
    #
    #     init_param_values[0] = theta1
    #     init_param_values[1] = phi1
    #     init_param_values[2] = lam1
    #
    #     print(Statevector(ansatz.assign_parameters(init_param_values)))
    #
    ...
    #         print(Statevector(ansatz.assign_parameters(parameter_values)))
    #
    #         # for i, parameter_value in enumerate(parameter_values):
    #         #     np.testing.assert_almost_equal(
    #         #         float(parameter_value), thetas_expected[i], decimal=2

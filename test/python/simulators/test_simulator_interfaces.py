...
from qiskit import BasicSimulators, IBMQ, LegacySimulators
...
class TestCrossSimulation(QiskitTestCase):
    ...
    def test_statevector(self):
        ...
        sim_py = BasicSimulators.get_backend('statevector_simulator')
    ...
    def test_qasm(self):
        ...
        sim_py = BasicSimulators.get_backend('qasm_simulator')
        shots = 2000

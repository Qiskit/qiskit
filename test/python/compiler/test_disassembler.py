...
class TestPulseScheduleDisassembler(QiskitTestCase):
    ...
    def test_disassemble_single_schedule(self):
        ...
        self.assertEqual(scheds[0], base_qobj_transform(sched))
    ...
    def test_disassemble_multiple_schedules(self):
        ...
        self.assertEqual(scheds[0], base_qobj_transform(sched0))
        self.assertEqual(scheds[1], base_qobj_transform(sched1))

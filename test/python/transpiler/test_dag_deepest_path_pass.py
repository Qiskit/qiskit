...
import unittest
from qiskit.transpiler.passes import DAGDeepestPath
from qiskit import QuantumRegister, QuantumCircuit
from qiskit.converters import circuit_to_dag
from qiskit.test import QiskitTestCase


class TestDAGDeepestPathPass(QiskitTestCase):
    ...
    def test_empty_dag_true(self):
        ...
        pass_ = DAGDeepestPath()
        pass_.run(dag)
        self.assertListEqual(pass_.property_set['dag_deepest_path'], [])
    ...
    def test_nonempty_dag_false(self):
        ...
        pass_ = DAGDeepestPath()
        pass_.run(dag)
        self.assertEqual(len(pass_.property_set['dag_deepest_path']), 11)

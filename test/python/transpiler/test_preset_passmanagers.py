...
class TestFinalLayouts(QiskitTestCase):
    ...
    def test_layout_tokyo_2845(self, level):
        ...
        csp_layout = {5: Qubit(QuantumRegister(3, 'qr1'), 1),
                      6: Qubit(QuantumRegister(3, 'qr1'), 2),
                      10: Qubit(QuantumRegister(2, 'qr2'), 0),
                      0: Qubit(QuantumRegister(3, 'qr1'), 0),
                      15: Qubit(QuantumRegister(2, 'qr2'), 1),
                      1: Qubit(QuantumRegister(15, 'ancilla'), 0),
                      2: Qubit(QuantumRegister(15, 'ancilla'), 1),
                      3: Qubit(QuantumRegister(15, 'ancilla'), 2),
                      4: Qubit(QuantumRegister(15, 'ancilla'), 3),
                      7: Qubit(QuantumRegister(15, 'ancilla'), 4),
                      8: Qubit(QuantumRegister(15, 'ancilla'), 5),
                      9: Qubit(QuantumRegister(15, 'ancilla'), 6),
                      11: Qubit(QuantumRegister(15, 'ancilla'), 7),
                      12: Qubit(QuantumRegister(15, 'ancilla'), 8),
                      13: Qubit(QuantumRegister(15, 'ancilla'), 9),
                      14: Qubit(QuantumRegister(15, 'ancilla'), 10),
                      16: Qubit(QuantumRegister(15, 'ancilla'), 11),
                      17: Qubit(QuantumRegister(15, 'ancilla'), 12),
                      18: Qubit(QuantumRegister(15, 'ancilla'), 13),
                      19: Qubit(QuantumRegister(15, 'ancilla'), 14)}

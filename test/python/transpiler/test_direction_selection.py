...
"""Test the Direction Selection pass"""

import unittest

from qiskit import ClassicalRegister, QuantumRegister, QuantumCircuit
from qiskit.transpiler import MapperError
from qiskit.transpiler.passes import DirectionSelection
from qiskit.mapper import Coupling
from qiskit.converters import circuit_to_dag
from ..common import QiskitTestCase


class TestDirectionSelection(QiskitTestCase):
    """ Tests the DirectionSelection pass."""
    ...
    def test_no_cnots(self):
        ...
        pass_ = DirectionSelection(coupling)
        after = pass_.run(dag)

...
from qiskit.transpiler.synthesis.solovay_kitaev import (
    SolovayKitaevDecomposition,
    SolovayKitaevSynthesisPlugin,
)
from qiskit.transpiler.synthesis.solovay_kitaev.generate_basis_approximations import (
    generate_basic_approximations,
)
from qiskit.transpiler.synthesis.solovay_kitaev.solovay_kitaev import commutator_decompose
from qiskit.transpiler.synthesis.solovay_kitaev.utils import GateSequence
...
class TestSolovayKitaev(QiskitTestCase):
    ...
    def test_plugin(self):
        ...
        plugin = SolovayKitaevSynthesisPlugin()
    ...
    def test_i_returns_empty_circuit(self):
        ...
        skd = SolovayKitaevDecomposition(3, self.basic_approx)
    ...
    def test_exact_decomposition_acts_trivially(self):
        ...
        synth = SolovayKitaevDecomposition(3, self.basic_approx)
    ...
    def test_str_basis_gates(self):
        ...
        synth = SolovayKitaevDecomposition(2, basic_approx)

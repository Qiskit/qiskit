...
class TestSolovayKitaev(QiskitTestCase):
    ...
    def test_i_returns_empty_circuit(self):
        """Test that ``SolovayKitaevSynthesis`` returns an empty circuit when
        it approximates the I-gate."""
        circuit = QuantumCircuit(1)
        circuit.i(0)

        skd = SolovayKitaevSynthesis(3, self.basic_approx)
    ...
    def test_exact_decomposition_acts_trivially(self):
        ...
        synth = SolovayKitaevSynthesis(3, self.basic_approx)
    ...
    def test_fails_with_no_to_matrix(self):
        ...
        self.assertEqual(
            "SolovayKitaevSynthesis does not support gate without to_matrix method: initialize",
    ...
    def test_str_basis_gates(self):
        ...
        synth = SolovayKitaevSynthesis(2, basic_approx)

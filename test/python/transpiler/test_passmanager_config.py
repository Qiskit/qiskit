...
from qiskit.providers.fake_provider import FakeMelbourne, FakeHanoi, FakeHanoiV2
...
class TestPassManagerConfig(QiskitTestCase):
    ...
    def test_str(self):
        """Test string output."""
        pm_config = PassManagerConfig.from_backend(FakeMelbourne())
        ...
        path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "melbourne_pm_config.txt")

    ...
    def test_pmatrix_class(self):
        ...
        for n in range(2, 8 + 1):
            ...
            for _ in range(200):
                ...
                pmat.mul_left_q1(L=C1, temp_mat=tmpA)
                pmat.mul_left_q1(L=C0, temp_mat=tmpA)
                pmat.mul_right_q1(L=C2, temp_mat=tmpA, dagger=True)
                ...
                alt_prod = pmat.product_q1(L=C4, tmpA=tmpA, tmpB=tmpB)

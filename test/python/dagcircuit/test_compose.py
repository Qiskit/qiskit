...
class TestDagCompose(QiskitTestCase):
    ...
    def test_compose_inorder(self):
        ...
        lqr_1_1: |0>───┤ X ├───     rqr_1: |0>──┼──┤ X ├     lqr_1_1: |0>───┤ X ├─────┼──┤ X ├
                    ┌──┴───┴──┐                 │  ├───┤                 ┌──┴───┴──┐  │  ├───┤
        lqr_1_2: |0>┤ U1(0.1) ├  +  rqr_2: |0>──┼──┤ Y ├  =  lqr_1_2: |0>┤ U1(0.1) ├──┼──┤ Y ├
                    └─────────┘               ┌─┴─┐└───┘                 └─────────┘┌─┴─┐└───┘
        lqr_2_0: |0>─────■─────     rqr_3: |0>┤ X ├─────     lqr_2_0: |0>─────■─────┤ X ├─────
                       ┌─┴─┐                  └───┘┌───┐                    ┌─┴─┐   └───┘┌───┐
    ...
    def test_compose_inorder_smaller(self):
        """Composing with a smaller RHS dag, default order.
                       ...
                       ┌───┐                       ┌─────┐                     ┌───┐        ┌─────┐
        lqr_1_0: |0>───┤ H ├───     rqr_0: |0>──■──┤ Tdg ├      lqr_1_0: |0>───┤ H ├─────■──┤ Tdg ├
                       ├───┤                  ┌─┴─┐└─────┘                     ├───┤   ┌─┴─┐└─────┘
        lqr_1_1: |0>───┤ X ├───     rqr_1: |0>┤ X ├───────      lqr_1_1: |0>───┤ X ├───┤ X ├───────
                    ┌──┴───┴──┐               └───┘                         ┌──┴───┴──┐└───┘
        lqr_1_2: |0>┤ U1(0.1) ├  +                          =   lqr_1_2: |0>┤ U1(0.1) ├────────────
                    └─────────┘                                             └─────────┘
        lqr_2_0: |0>─────■─────                                 lqr_2_0: |0>─────■─────────────────
                       ┌─┴─┐                                                   ┌─┴─┐
    ...
    def test_compose_permuted(self):
        ...
        {0: 3, 1: 1, 2: 2, 3: 4, 4: 0}
                        ┌───┐                                                  ┌───┐   ┌───┐
         lqr_1_0: |0>───┤ H ├───      rqr_0: |0>──■───────      lqr_1_0: |0>───┤ H ├───┤ Z ├
                        ├───┤                     │  ┌───┐                     ├───┤   ├───┤
         lqr_1_1: |0>───┤ X ├───      rqr_1: |0>──┼──┤ X ├      lqr_1_1: |0>───┤ X ├───┤ X ├
                     ┌──┴───┴──┐                  │  ├───┤                  ┌──┴───┴──┐├───┤
         lqr_1_2: |0>┤ U1(0.1) ├      rqr_2: |0>──┼──┤ Y ├      lqr_1_2: |0>┤ U1(0.1) ├┤ Y ├
                     └─────────┘                ┌─┴─┐└───┘                  └─────────┘└───┘
         lqr_2_0: |0>─────■─────  +   rqr_3: |0>┤ X ├─────   =  lqr_2_0: |0>─────■───────■──
                        ┌─┴─┐                   └───┘┌───┐                     ┌─┴─┐   ┌─┴─┐
    ...
    def test_compose_permuted_smaller(self):
        ...
        {0: 3, 1: 2}
                       ...
                       ┌───┐                       ┌─────┐                     ┌───┐
        lqr_1_0: |0>───┤ H ├───     rqr_0: |0>──■──┤ Tdg ├      lqr_1_0: |0>───┤ H ├───────────────
                       ├───┤                  ┌─┴─┐└─────┘                     ├───┤
        lqr_1_1: |0>───┤ X ├───     rqr_1: |0>┤ X ├───────      lqr_1_1: |0>───┤ X ├───────────────
                    ┌──┴───┴──┐               └───┘                         ┌──┴───┴──┐┌───┐
        lqr_1_2: |0>┤ U1(0.1) ├  +                          =   lqr_1_2: |0>┤ U1(0.1) ├┤ X ├───────
                    └─────────┘                                             └─────────┘└─┬─┘┌─────┐
        lqr_2_0: |0>─────■─────                                 lqr_2_0: |0>─────■───────■──┤ Tdg ├
                       ┌─┴─┐                                                   ┌─┴─┐        └─────┘
        lqr_2_1: |0>───┤ X ├───                                 lqr_2_1: |0>───┤ X ├───────────────
                       └───┘                                                   └───┘
        lcr_0: 0 ══════════════                                 lcr_0: 0 ══════════════════════════
    ...
    def test_compose_classical(self):
        ...
        clbit map: {0: 1, 1: 0}
                       ...
                       ┌───┐                       ┌─────┐┌─┐                      ┌───┐
        lqr_1_0: |0>───┤ H ├───     rqr_0: |0>──■──┤ Tdg ├┤M├       lqr_1_0: |0>───┤ H ├──────────────────
                       ├───┤                  ┌─┴─┐└─┬─┬─┘└╥┘                      ├───┤        ┌─────┐┌─┐
        lqr_1_1: |0>───┤ X ├───     rqr_1: |0>┤ X ├──┤M├───╫─       lqr_1_1: |0>───┤ X ├─────■──┤ Tdg ├┤M├
                    ┌──┴───┴──┐               └───┘  └╥┘   ║                    ┌──┴───┴──┐  │  └─────┘└╥┘
        lqr_1_2: |0>┤ U1(0.1) ├  +   rcr_0: 0 ════════╬════╩═  =    lqr_1_2: |0>┤ U1(0.1) ├──┼──────────╫─
                    └─────────┘                       ║                         └─────────┘  │          ║
        lqr_2_0: |0>─────■─────      rcr_1: 0 ════════╩══════       lqr_2_0: |0>─────■───────┼──────────╫─
                       ┌─┴─┐                                                       ┌─┴─┐   ┌─┴─┐  ┌─┐   ║
        lqr_2_1: |0>───┤ X ├───                                     lqr_2_1: |0>───┤ X ├───┤ X ├──┤M├───╫─
                       └───┘                                                       └───┘   └───┘  └╥┘   ║
        lcr_0: 0 ══════════════                                        lcr_0: 0 ═══════════════════╩════╬═
                                                                                                        ║
        lcr_1: 0 ══════════════                                        lcr_1: 0 ════════════════════════╩═

...
class TestCollectBlocks(QiskitTestCase):
    ...
    def test_collect_gates_from_dagdependency_v2_1(self):
        ...
        block_collector = BlockCollector(circuit_to_dagdependency_v2(qc))
        blocks = block_collector.collect_all_matching_blocks(
            lambda node: node.op.name == "cx",
            split_blocks=False,
            min_block_size=1,
    ...
    def test_collect_gates_from_dagdependency_v2_2(self):
    ...
    def test_collect_and_split_gates_from_dagdependency_v2(self):
    ...
    def test_circuit_has_measure_dagdependency_v2(self):
        """Test that block collection works properly when there is a measure in the
        middle of the circuit."""
    ...
    def test_circuit_has_conditional_gates_dagdependency_v2(self):
        """Test that block collection works properly when there the circuit
        contains conditional gates."""
    ...
    def test_do_not_split_blocks_v2(self):
        """Test that splitting blocks of nodes into sub-blocks works correctly."""
        ...
        block_collector = BlockCollector(circuit_to_dagdependency_v2(circuit))
    ...
    def test_collect_blocks_with_cargs_dagdependency_v2(self):
        """Test collecting and collapsing blocks with classical bits appearing as cargs,
        using DAGDependency."""
    ...
    def test_collect_blocks_with_clbits_dagdependency_v2(self):
    ...
    def test_collect_blocks_with_clbits2_dagdependency_v2(self):
        """Test collecting and collapsing blocks with classical bits appearing under
    ...
    def test_collect_blocks_with_cregs_dagdependency_v2(self):
        """Test collecting and collapsing blocks with classical registers appearing under
        condition, using DAGDependency."""
    ...
    def test_collect_blocks_backwards_dagdependency_v2(self):
    ...
    def test_split_layers_dagdependency_v2(self):
        """Test that splitting blocks of nodes into layers works correctly."""

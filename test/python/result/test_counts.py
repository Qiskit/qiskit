...
class TestCounts(unittest.TestCase):
    ...
    def test_marginal_counts(self):
        ...
        counts_obj = counts.Counts(raw_counts, creg_sizes=[['c0', 4]],
                                   memory_slots=4)
    ...
    def test_qudit_counts(self):
        raw_counts = {'00': 121, '01': 109, '02': 114, '10': 113, '11': 106,
    ...
    def test_qudit_counts_raises_with_format(self):
        raw_counts = {'00': 121, '01': 109, '02': 114, '10': 113, '11': 106,
                      '12': 114, '20': 117, '21': 104, '22': 102}
        self.assertRaises(exceptions.QiskitError, counts.Counts, raw_counts,
                          creg_sizes=[['c0', 4]])

...
impl CircuitData {
    ...
    /// Add a declared variable to the circuit.
    ///
    /// Args:
    ///     var: the variable to add.
    ...
    /// Check if this variable is in the circuit.
    ///
    /// Args:
    ...
    /// Check if the circuit contains an input variable with the specified name.
    ...
    /// Check if the circuit contains a local variable with the specified name.
    ...
    /// Check if the circuit contains a capture variable with the specified name.
    ...
    /// Return the variable in the circuit corresponding to the specified name, or None if no such variable.                                                                                                                                                                                                                                                                  Return the variable in the circuit corresponding to the given name, or None if no such variable.
    #[pyo3(name = "get_var")]

...
«     │                     ││          ││                     │
«q_1: ┤                     ├┤0         ├┤3                    ├
«     │  my medium identity ││  Unitary ││  my bigger identity │
«     │                     ││          ││                     │
«q_2: ┤1                    ├┤3         ├┤1                    ├
«     │                     ││          ││                     │
«     │                     ││          ││                     │
...
«       │             │                    │                         │             »
«     ┌─┴─┐┌──────┐   │    ┌────────┐┌─────┴─────┐                 ┌─┴─┐           »
«q_1: ┤ Z ├┤0     ├───X────┤0       ├┤ Rx(3.141) ├──────■──────────┤ S ├───────■───»
«     └───┘│  Dcx │        │  Iswap │└───────────┘      │          └───┘       │   »
«          │      │┌──────┐│        │             ┌─────┴─────┐             ┌──┴──┐»
«q_2: ──■──┤1     ├┤0     ├┤1       ├──■──────────┤ Ry(3.141) ├──────■──────┤ Sdg ├»
«       │  └──────┘│  Ecr │└────────┘  │P(3.141)  └───────────┘      │      └─────┘»
«     ┌─┴─┐        │      │            │                       ┌─────┴─────┐       »
«q_3: ┤ Y ├────────┤1     ├────────────■───────────────────────┤ Rz(3.141) ├───────»
«     └───┘        └──────┘                                    └───────────┘       »
...
«     ┌─────────────┐│             │┌─────────────────────┐                       »
«q_1: ┤0            ├┤1            ├┤0                    ├───────────────────────»
«     │  Ryy(3.141) │└─────────────┘│  XX-YY(3.141,3.141) │                       »
«     │             │┌─────────────┐│                     │┌─────────────────────┐»
«q_2: ┤1            ├┤0            ├┤1                    ├┤0                    ├»
«     └─────────────┘│  Rzz(3.141) │└─────────────────────┘│  XX+YY(3.141,3.141) │»
«                    │             │                       │                     │»
«q_3: ───────────────┤1            ├───────────────────────┤1                    ├»
«                    └─────────────┘                       └─────────────────────┘»
«                                                                                 »

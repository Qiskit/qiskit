...
#[cfg(feature = "py")]
use crate::annotation::create_py_annotation;
...
pub fn multiply_param(param: &Param, mult: f64) -> Param {
    match param {
        ...
        Param::Int(_) => {
            unreachable!("Unsupported multiplication of a Param::Int.")
        }
        #[cfg(feature = "py")]
...
pub fn add_param(param: &Param, summand: f64) -> Param {
    match param {
        ...
        Param::Int(_) => unreachable!("Unsupported addition of a Param::Int."),
    }
}

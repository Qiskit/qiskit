...
/// ```
#[derive(Default)]
pub struct Interner<T: ?Sized + ToOwned>(IndexSet<<T as ToOwned>::Owned, ::foldhash::fast::RandomState>);
    ...
    <T as ToOwned>::Owned: Hash + Eq + Default,
{
    ...
    pub fn with_capacity(capacity: usize) -> Self {
        let mut set = IndexSet::with_capacity_and_hasher(capacity, ::foldhash::fast::RandomState::default());

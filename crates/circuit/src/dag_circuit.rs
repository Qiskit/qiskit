...
use crate::operations::{
    ...
    PythonOperation, StandardGate, StandardInstruction, Target,
};
...
use crate::{converters, imports, Clbit, Qubit, Stretch, TupleLikeArg, Var, VarsMode};
        ...
        F: Fn(Wire) -> (PackedOperation, SmallVec<[Param; 3]>),
    {
        ...
        for (source, target, weight) in edge_list {
            ...
            let py_op = match new_op.view() {
                ...
                | OperationRef::ControlFlow(_) => OnceLock::new(),

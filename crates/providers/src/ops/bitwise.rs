...
use super::error::{MathOpError, check_axis, check_dtype};
...
bitwise_binary_op!(BitwiseAnd, "bitwise_and", Tensor::bitand_tensor);
bitwise_binary_op!(BitwiseOr, "bitwise_or", Tensor::bitor_tensor);

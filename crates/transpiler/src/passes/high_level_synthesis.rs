...
use qiskit_synthesis::two_qubit_decompose::{ndarray_to_matrix4, TwoQubitBasisDecomposer};
        ...
        OperationRef::Unitary(unitary) => {
            ...
            match unitary.shape() {
                ...
                [4, 4] => {
                    ...
                    let two_qubit_sequence = decomposer.call_inner(
                        ndarray_to_matrix4(unitary.view())?,
                        None,
                        false,
                        None,
                    )?;

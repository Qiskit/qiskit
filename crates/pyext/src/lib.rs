...
use qiskit_accelerate::{
    ...
    euler_one_qubit_decomposer::euler_one_qubit_decomposer, isometry::isometry,
    linear_matrix::linear_matrix, nlayout::nlayout, optimize_1q_gates::optimize_1q_gates,
...
fn _accelerate(m: &Bound<PyModule>) -> PyResult<()> {
    ...
    m.add_wrapped(wrap_pymodule!(clifford))?;

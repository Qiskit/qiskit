...
use qiskit_accelerate::{
    ...
    convert_2q_block_matrix::convert_2q_block_matrix, dense_layout::dense_layout, elide_permutations::elide_permutations,
...
fn _accelerate(m: &Bound<PyModule>) -> PyResult<()> {
    ...
    add_submodule(m, elide_permutations, "elide_permutations")?;

...
/// \inlinerst ::ref:`transpiler-preset-stage-init` \endrst for more details.
///
...
/// The Qiskit transpiler is a quantum circuit compiler that rewrites a given
/// input circuit to match the constraints of a QPU and optimizes the circuit
/// for execution. This function runs the third stage of the transpiler,
/// **routing**, which translates all the instructions in the circuit into
/// those supported by the target. You can refer to
/// \inlinerst ::ref:`transpiler-preset-stage-routing` \endrst for more details.
///
/// This function should only be used with circuits constructed
/// using Qiskit's C API. It makes assumptions on the circuit only using features exposed via C,
/// if you are in a mixed Python and C environment it is typically better to invoke the transpiler
...
pub unsafe extern "C" fn qk_transpile_stage_routing(
    ...
    // SAFETY: Per the documentation this is a valid pointer to a pointer to a transpile layout
    let transpile_layout = unsafe { mut_ptr_as_ref(*layout) };
    match routing_stage(
        dag,
        target,
        options.optimization_level.into(),
...
/// The Qiskit transpiler is a quantum circuit compiler that rewrites a given
/// input circuit to match the constraints of a QPU and optimizes the circuit
/// for execution. This function runs the fourth stage of the transpiler,
/// **optimization**, which translates all the instructions in the circuit into
/// those supported by the target. You can refer to
/// \inlinerst ::ref:`transpiler-preset-stage-optimization` \endrst for more details.
///
/// This function should only be used with circuits constructed
/// using Qiskit's C API. It makes assumptions on the circuit only using features exposed via C,
/// if you are in a mixed Python and C environment it is typically better to invoke the transpiler
...
/// those supported by the target. You can refer to
/// \inlinerst ::ref:`transpiler-preset-stage-translation` \endrst for more details.
///
/// This function should only be used with circuits constructed
/// using Qiskit's C API. It makes assumptions on the circuit only using features exposed via C,
/// if you are in a mixed Python and C environment it is typically better to invoke the transpiler
...
/// The Qiskit transpiler is a quantum circuit compiler that rewrites a given
/// input circuit to match the constraints of a QPU and optimizes the circuit
/// for execution. This function runs the second stage of the transpiler,
...
/// \inlinerst ::ref:`transpiler-preset-stage-layout` \endrst for more details.
///
/// This function should only be used with circuits constructed
/// using Qiskit's C API. It makes assumptions on the circuit only using features exposed via C,
/// if you are in a mixed Python and C environment it is typically better to invoke the transpiler

...
pub struct DAGCircuit {
    ...
    dag: StableDiGraph<NodeType, IndexType>,
...
impl DAGCircuit {
    ...
    #[getter]
    pub fn get_node_counter(&self) -> usize {
        self.dag.node_count()
    }

    /// Return the global phase of the circuit.
    #[getter]
    pub fn get_global_phase(&self) -> &PyObject {
        &self.global_phase
    }
    ...
    #[setter]
    pub fn set_global_phase(&mut self, py: Python<'_>, angle: &Bound<PyAny>) -> PyResult<()> {
        if let Some(angle) = angle.downcast::<PyFloat>().ok() {
    ...
    #[getter]
    pub fn get_calibrations(&self) -> PyObject {
        todo!()
    }
    ...
    #[setter]
    pub fn set_calibrations(&self, calibrations: &Bound<PyDict>) {
        todo!()
    }
    ...
    pub fn remove_all_ops_named(&self, py: Python<'_>) -> PyResult<()> {
        Ok(())
    }

...
static SUPPORTED_ROTATIONS: Lazy<HashMap<&str, Option<OperationRef>>> = Lazy::new(|| {
    HashMap::from([
        ("rx", Some(OperationRef::StandardGate(StandardGate::X))),
        ("ry", Some(OperationRef::StandardGate(StandardGate::Y))),
        ("rz", Some(OperationRef::StandardGate(StandardGate::Z))),
        ("p", Some(OperationRef::StandardGate(StandardGate::Z))),
        ("u1", Some(OperationRef::StandardGate(StandardGate::Z))),
        ...
        (
            "crx",
            Some(OperationRef::StandardGate(StandardGate::CX)),
        ),
        (
            "cry",
            Some(OperationRef::StandardGate(StandardGate::CY)),
        ),
        (
            "crz",
            Some(OperationRef::StandardGate(StandardGate::CZ)),
        ),
        ("cp", Some(OperationRef::StandardGate(StandardGate::CZ))),
    ])
});

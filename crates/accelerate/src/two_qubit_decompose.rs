...
use qiskit_circuit::util::{GateArray1Q, GateArray2Q, IM, M_IM, M_ONE, ONE, ZERO};
...
static B_NON_NORMALIZED_DAGGER: GateArray2Q = [
    [c64!(0.5, 0), ZERO, ZERO, c64!(0.5, 0)],
    [c64!(0, -0.5), ZERO, ZERO, c64!(0, 0.5)],
    [ZERO, c64!(0, -0.5), c64!(0, -0.5), ZERO],
    [ZERO, c64!(0.5, 0), c64!(-0.5, 0), ZERO],
];
...
fn rz_matrix(theta: f64) -> Array2<Complex64> {
    ...
    array![[(-ilam2).exp(), ZERO], [ZERO, ilam2.exp()]]
}
...
static IPZ: GateArray1Q = [[IM, ZERO], [ZERO, M_IM]];
static IPY: GateArray1Q = [[ZERO, ONE], [M_ONE, ZERO]];
static IPX: GateArray1Q = [[ZERO, IM], [IM, ZERO]];
...
impl TwoQubitBasisDecomposer {
    ...
    fn new(
        ...
        let k22r_arr: GateArray1Q = [[ZERO, ONE], [M_ONE, ZERO]];
